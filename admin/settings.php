                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="name" name="email" id="email_inp" class="form-control shadow-none" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="name" name="iframe" id="iframe_inp" class="form-control shadow-none" required>
                                                </div>
                                            </div>
                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <button type="button" class="btn btn-dark shadow-none bts-sm" data-bs-toggle="modal" data-bs-target="#team-s">
                        ...
                        <form id="team_s_form">
                            <div class="modal-content">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="name" name="member" id="member_name_inp" class="form-control shadow-none" required>
                                </div>
                                <div class="mb-3">
    ...
    <script>
        ...
        function contacts_inp(data){
            let contacts_inp_id = ['address_inp', 'gmap_inp', 'pn1_inp', 'pn2_inp',
                                   'email_inp', 'fb_inp', 'insta_inp', 'tw_inp', 'iframe_inp'];
        ...
        function upd_contacts(){
            ...
            let contacts_inp_id = ['address_inp', 'gmap_inp', 'pn1_inp', 'pn2_inp', 'email_inp',
                                'fb_inp', 'insta_inp', 'tw_inp', 'iframe_inp'];
