...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <?php 
            ...
            while($room_data = mysqli_fetch_assoc($room_res)){
                ...
                $room_thumb = ROOMS_IMG_PATH."simple1.jpg";
        ...
        ?>
            <div class="col-lg-12 text-center mt-5">
                <a href="rooms.php" class="btn btn-sm btn-outline-dark round-0 rw-bold shadow-none">More Rooms >>></a>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5">
        <div class="swiper swiper-testimonials">
            ...
            <div class="col-lg-12 text-center mt-5">
                <a href="about.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">More Facilities >>></a>
            </div>
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="bg-white p-4 rounded mb-4">
                    ...
                    <?php 
                        if($contact_r['tw']!=''){
                            echo<<<data
                                <a href="$contact_r[tw]" class="d-inline-block text-decoration-none text-dark">
                    ...
                    <br>
                    <a href="<?php echo $contact_r['fb']?>" class="d-inline-block text-decoration-none text-dark">
